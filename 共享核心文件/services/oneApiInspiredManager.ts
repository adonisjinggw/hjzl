 ...
 */
export class OneApiInspiredManager {
  private static instance: OneApiInspiredManager;
   ...
   * 获取单例实例
   */
  public static getInstance(): OneApiInspiredManager {
    if (!OneApiInspiredManager.instance) {
      OneApiInspiredManager.instance = new OneApiInspiredManager();
    }
    return OneApiInspiredManager.instance;
  }
 ...
 * 导出单例实例
 */
export const oneApiManager = OneApiInspiredManager.getInstance();
  ...
  return function (
    ...
    descriptor.value = async function (...args: T): Promise<R> {
      ...
      try {
        ...
        oneApiManager.recordApiCall(provider, service, false, responseTime, { errorMessage });
        throw error;
      }
    };
